...
const turbo_helpers_1 = __nccwpck_require__(4504);
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const majorTurboVersion = (0, turbo_helpers_1.getTurboMajorVersion)(workingDirectory);
 ...
 * @returns 1 | 2
 */
const getTurboMajorVersion = (workingDirectory) => {
    const turboMajorVersion = (0, core_1.getInput)('turbo-major-version', { required: false });
    if (!turboMajorVersion) {
        (0, core_1.debug)('Reading package.json to find turbo version');
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const { devDependencies, dependencies } = require((0, path_1.join)(workingDirectory, 'package.json'));
        const turboMajorVersion = (devDependencies === null || devDependencies === void 0 ? void 0 : devDependencies.turbo) || (dependencies === null || dependencies === void 0 ? void 0 : dependencies.turbo);
        if (!turboMajorVersion) {
    ...
    const major = semver_1.default.major(turboMajorVersion);
    if (major < 1 || major > 2) {
...
const getTurboChangedWorkspaces = (_a) => __awaiter(void 0, [_a], void 0, function* ({ majorTurboVersion, turboTaskName, workspace, from, to, workingDirectory, }) {
    ...
    const json = yield (0, child_process_1.execSync)(`TURBO_TELEMETRY_DISABLED=1 TURBO_TELEMETRY_MESSAGE_DISABLED=1 npx turbo@^${majorTurboVersion} run ${turboTaskName} --filter="${workspace}...[${from}...${to}]" --dry-run=json`, {
