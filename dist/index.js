...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const json = yield (0, child_process_1.execSync)(`TURBO_TELEMETRY_DISABLED=1 TURBO_TELEMETRY_MESSAGE_DISABLED=1 npx turbo@^1 run ${turboTaskName} --filter="${workspace}...[${from}...${to}]" --dry-run=json`, {
